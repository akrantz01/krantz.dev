/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 704a3e6aefd94874084da0f6a9b6f535)
// Runtime types generated with workerd@1.20251210.0 2026-01-03 nodejs_als
declare namespace Cloudflare {
	interface Env {
		AUTHENTICATION_CLIENT_ID: string;
		AUTHENTICATION_CLIENT_SECRET: string;
		AUTHENTICATION_EDITOR_GROUP: string;
